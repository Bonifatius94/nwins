...
public class GameSession : IGameSession
{
    ...
    /// <param name="settings">The game settings to be applied.
    /// (Default: 5 x 4 Board, 4 Connections)</param>
    ...
    public IGameSummary PlayGameToEnd()
    {
        ...
        do
        {
            ...
            isActionIntoTie = i == Settings.Rows * Settings.Columns - 1 &&
                !log.NewState.IsConnectN(Settings.StonesToConnect);
        }
